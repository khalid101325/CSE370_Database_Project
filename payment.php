<?php
	...
	if(isset($_POST['submit_payment']))
	{
	    ...
	    if(empty($amount) || empty($payment_method) || empty($payment_date) || empty($transaction_id))
	    {
		...
		}else
		{
		    ...
		    if($ins->execute())
		    {
		        $success = "Payment submitted successfully! Status: Pending.";
		    }else
		    {
	...
	$h_stmt = $con->prepare("SELECT payment_id, transaction_id, payment_method, payment_date, amount, payment_status FROM Payment ORDER BY payment_id DESC");
	$h_stmt->execute();
...
<div class="payment-wrap">
    ...
    <div class="box">
        ...
        <form method="POST">
            ...
            <p class="note">* Enter the Transaction ID you received after sending money. Admin will verify and update the status.</p>
